  ...
  success:    function(data){
	...
	if(data["resultsPage"]["results"]["event"][i]["performance"].length != 1){
		...
		if(data["resultsPage"]["results"]["event"][i]["performance"][a]["artist"]["displayName"] != "Hearse Pileup"){
		    artists += '<dd><a href="' + data["resultsPage"]["results"]["event"][i]["performance"][a]["artist"]["uri"] + '">' + data["resultsPage"]["results"]["event"][i]["performance"][a]["artist"]["displayName"] + '</a></dd>'
		}
	    })
	}
	if(artists === ""){
	...
	$("#events").append('<li><h2><a href="'+ data["resultsPage"]["results"]["event"][i]["uri"] + '"><span>'
